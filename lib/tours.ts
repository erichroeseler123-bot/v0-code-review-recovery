...
export const TOURS: Tour[] = [
  ...
  // ─────────────── SOMERSET AMPHITHEATER (Rezdy widget booking) ───────────────
  // The storefront explains the offer. Rezdy handles date/time selection, payment,
  // and booking confirmation through the embedded operator widget.
  {
    slug: "somerset-amphitheater-private-suburban",
    marketId: "somerset",
    title: "Private Somerset Amphitheater Transportation",
    location: "Somerset Amphitheater",
    category: "Transport",
    providerRef: "766964",
    shortDescription: "Private Suburban transportation to Somerset Amphitheater for $399.",
    description:
      "Private Somerset Amphitheater transportation for your group in a Suburban. Book online, choose your date and time, and complete payment in Rezdy. Rezdy handles the booking confirmation while your ride plan covers private pickup and return after the show.",
    durationHours: 5,
    priceFromCents: 39900,
    image: "",
    highlights: [
      "Private Suburban for your group",
      "Private pickup and return after the show",
      "Book online through Rezdy",
      "Rezdy handles payment and confirmation",
    ],
    groupSize: "Private Suburban",
  },
]
